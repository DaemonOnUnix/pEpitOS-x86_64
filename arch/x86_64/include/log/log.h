...
#define LOG_OK(...) roprint(OK_STRING); printf(__VA_ARGS__); roprint("\n");
#define LOG_ERR(...) roprint(ERR_STRING); printf(__VA_ARGS__); roprint("\n");
#define LOG_INFO(...) roprint(INFO_STRING); printf(__VA_ARGS__); roprint("\n");
#define LOG_PANIC(...) roprint(PANIC_STRING); printf(__VA_ARGS__); roprint("\n");
